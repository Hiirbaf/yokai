...
class BasePreferences(private val preferenceStore: PreferenceStore) {
    ...
    enum class AppIcons(val displayName: String, val id: String, val icon: Int) {
        DEFAULT("Default", "${BuildConfig.APPLICATION_ID}.MainActivityDefault", R.mipmap.ic_launcher),
        GRAY("Gray", "${BuildConfig.APPLICATION_ID}.MainActivityGray", R.mipmap.ic_launcher_gray),
    }
}
